function Lab12(robot_id, spd)
   ...
   % ri = RobotInterface(robot_id, robot_starting_pose, wm);
    ...
    schedule = [...
        ...
        Job( JID.DROP, pose(0.5*ft, -1.75*ft, pi), speed ), ...
        ...
        Job( JID.WAIT, 0.1 ), ...
        Job( JID.PICK, pose(3.5*ft, -2*ft, 0), speed),  ...
        Job( JID.DROP, pose(0.5*ft, -2.25*ft, pi), speed), ...
        Job(JID.WAIT, 0.1),...
        Job( JID.PICK, pose(3.5*ft, -3*ft, 0), speed),  ...
        Job( JID.DROP, pose(0.5*ft, -2.75*ft, pi), speed), ...
        Job(JID.WAIT, 1)...
    ];
